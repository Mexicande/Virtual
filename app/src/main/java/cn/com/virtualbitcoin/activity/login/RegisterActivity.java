...
public class RegisterActivity extends BaseActivity {
    ...
    @OnClick({R.id.iv_close, R.id.super_Button, R.id.bt_getCode})
    ...
    private void setRegister(final String phone,String password,String repassword,String code ) {
        ...
        Api.getReQuest(Api.GET_REGISTER, this, jsonObject, new OnRequestDataListener() {
            @Override
    ...
    private void getCodeMessage(final String phone) {
        ...
        Api.getReQuest(Api.SEED_MESS, this, jsonObject, new OnRequestDataListener() {
            @Override
            public void requestSuccess(int code, JSONObject data) {
