...
public class UpdateDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    //默认色
    private int mDefaultColor = R.color.colorPrimary;
...
//                });
    ...
    private void setDialogTheme(int color, int topResId) {
        ...
        mUpdateOkButton.setBackgroundDrawable(DrawableUtil.getDrawable(AppUpdateUtils.dip2px(4, getActivity()), getResources().getColor(R.color.colorPrimary)));
