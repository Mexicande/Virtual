...
public final class ActivityUtils {
     ...
     * @param isLoadAnim Whether use animation for the outgoing activity.
     */
    private static void finishActivity(@NonNull final Class<?> clz, final boolean isLoadAnim) {
        List<Activity> activities = Utils.sActivityList;
     ...
     * @param isLoadAnim    Whether use animation for the outgoing activity.
     */
    private static boolean finishToActivity(@NonNull final Activity activity,
                                            final boolean isIncludeSelf,
     ...
     * @param isLoadAnim    Whether use animation for the outgoing activity.
     */
    private static boolean finishToActivity(@NonNull final Class<?> clz,
                                            final boolean isIncludeSelf,
                                            final boolean isLoadAnim) {
        List<Activity> activities = Utils.sActivityList;
        for (int i = activities.size() - 1; i >= 0; --i) {
     ...
     * @param isLoadAnim Whether use animation for the outgoing activity.
     */
    private static void finishOtherActivities(@NonNull final Class<?> clz,
                                              final boolean isLoadAnim) {
        List<Activity> activities = Utils.sActivityList;
        for (int i = activities.size() - 1; i >= 0; i--) {
     ...
     * @param isLoadAnim Whether use animation for the outgoing activity.
     */
    private static void finishAllActivities(final boolean isLoadAnim) {
     ...
     * @param isLoadAnim Whether use animation for the outgoing activity.
     */
    private static void finishAllActivitiesExceptNewest(final boolean isLoadAnim) {
        List<Activity> activities = Utils.sActivityList;
     ...
     * @return the icon of activity
     */
    private static Drawable getActivityIcon(final ComponentName activityName) {
        PackageManager pm = Utils.getApp().getPackageManager();
        try {
